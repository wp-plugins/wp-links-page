...
Plugin URI:  http://wordpress.org/extend/plugins/wp-links-page/
...
/*
 * Creating the WP Links Page Free database table *edited
 */

$upload_dir = wp_upload_dir();
$wplpf_upload = $upload_dir['basedir'].'/'.'wp-links-page/';
...
if (!defined('WPLPF_UPLOAD_URL')) {
    define('WPLPF_UPLOAD_URL', $upload_dir['baseurl'].'/'.'wp-links-page/');
}
...
function enqueue_wp_links_page_free_script($pagenow) {
	...
	wp_enqueue_script( 'wp-links-free-page', plugins_url( 'wp-links-page/wp-links-page-free.js', 'wp-links-page-free' ), null, null, true );
	wp_localize_script( 'wp-links-free-page', 'ajax_object', array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
	wp_enqueue_style( 'wp-links-free-style', plugins_url( 'wp-links-page/wp-links-page-free.css', 'wp-links-page-free' ), null, null, false );
}	
...
function wp_links_page_free_options() {
	...
	echo '<h1>Edit WP Links Page Free Setup</h1>
			<p class="message-limit" style="display:none;">You are limited to ten links with this plugin. For more links, purchase the full version at <a href="http://www.wplinkspage.com/purchase/" target="_blank">WPLinksPage.com</a>.</p>
...
<p style="font-weight: bold;">With this version you are limited to ten links only. <a href="http://www.wplinkspage.com/" target="_blank">Purchase the pro version for unlimited links and extra features such as organizing your links by category.</a></p>
...
<p style="font-weight: bold;">With the pro version you also have the option to stop the automatic screen refresh, and add a pager to your links. <a href="http://www.wplinkspage.com/" target="_blank">Purchase the pro version for these extra features.</a></p>
...
<p><strong>&#91;wp_links_page category=&quot;Category Name&quot;]</strong></p>
<ul>
<li>Displays all links in listed category.</li>
<li>This option is case sensitive. Make sure you type the category exactly as it is set on the Categories Page.</li>
<li><strong>Allowed Options: </strong>Any Set Category</li>
</ul>
<p><strong>&#91;wp_links_page pager=&quot;10&quot;]</strong></p>
<ul>
<li>Limits the amount of links shown per page</li>
<li>e.g. if 10 is chosen only 10 links will display on each page.</li>
<li>Using "all" in this option will show all links without a pager.</li>
<li><strong>Allowed Options: </strong>any number, or "all"</li>
</ul>
...
function wp_links_page_free_links() {
	...
	foreach ($links as $link) {
		...
		$urlParts = parse_url($input);
		$domain = preg_replace('/^www\./', '', $urlParts['host']);
		$content .= '<a class="wplpf-link wplpf-'.$grid.$clear.'" href="'.$link->url.'" target="_blank"><div class="wplpf-link-grid"><img src="'.$link->img.'" ><p class="url">'.$domain.'</p>';
		if ($grid == 'list') {
