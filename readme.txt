...
**This free version only allows ten links to be added.**
...
* Screenshots can be updated on schedule or by command.
* A widget is provided to showcase links in sidebar.

= Build Awesome Websites =

* Links can be added, edited, and reordered on the setup page.
...
* Select width of grids from one to five columns.
...
With this version you are limited to ten links only. 
